...
def generate1():
    ...
    #        MACHINE = "dagsmv200"
            ...
            MACHINE = "gb7356"
        elif (BUILDMACHINE == "gbquad4k") or (BUILDMACHINE == "gbue4k") or (BUILDMACHINE == "gbquad4kpro"):
            MACHINE = "gb7252"
